...
{
  private static StringToArrayUtility instance;  //singleton instance

  private StringToArrayUtility()
  {
  }

  public static synchronized StringToArrayUtility getInstance()
  {
    if (instance == null) instance = new StringToArrayUtility();
    return instance;
  }
