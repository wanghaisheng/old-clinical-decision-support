...
{
  private static LogicHelperUtility instance;  //singleton instance
  ...
  public static synchronized LogicHelperUtility getInstance()
  {
    if (instance == null) instance = new LogicHelperUtility();
    return instance;
  }
