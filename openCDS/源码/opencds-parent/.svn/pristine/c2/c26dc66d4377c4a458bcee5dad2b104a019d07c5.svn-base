...
public abstract class NestedObjectsMapper extends Object {
		...
		throws ImproperUsageException, DataFormatException, InvalidDataException
	{
		...
		if ( "AdministrableSubstance".equals(externalSchemaSourceEntity.getClass().getSimpleName()) ) {
			...
			throw new InvalidDataException(_METHODNAME + "Unrecognized class: " + externalSchemaSourceEntity.getClass().getSimpleName());
		}
	...
	public static Object pushOutRelatedEntityNestedObjects(
			String										sourceId,
			Object										outerTarget,
			OrganizedResults 							organizedResults) 
		throws ImproperUsageException, DataFormatException, InvalidDataException
		...
		for ( EntityRelationship oneInternalEntityRelationship : organizedResults.getEntityChildren().get(sourceId)) {
			...
			if ( "AdministrableSubstance".equals(thisInternalNestedEntity.getClass().getSimpleName()) ) {
				...
				if ("AdministrableSubstance".equals(outerTarget.getClass().getSimpleName())) {
					if ("org.opencds.vmr.v1_0.schema.RelatedEntity.AdministrableSubstance".equals(outerTarget.getClass().getName())) {
						((org.opencds.vmr.v1_0.schema.RelatedEntity.AdministrableSubstance)outerTarget).getRelatedEntity().add(schemaRelatedEntity);
					} else {
						((org.opencds.vmr.v1_0.schema.AdministrableSubstance)outerTarget).getRelatedEntity().add(schemaRelatedEntity);
					}
					...
					((org.opencds.vmr.v1_0.schema.Facility)outerTarget).getRelatedEntity().add(schemaRelatedEntity);
				} else if ("Organization".equals(outerTarget.getClass().getSimpleName())) {
					((org.opencds.vmr.v1_0.schema.Organization)outerTarget).getRelatedEntity().add(schemaRelatedEntity);
					...
					((org.opencds.vmr.v1_0.schema.Specimen)outerTarget).getRelatedEntity().add(schemaRelatedEntity);
				} else {
					throw new InvalidDataException("_METHOD_NAME + Unrecognized outerTarget class: " + outerTarget.getClass().getSimpleName());
				}
