...
/**
 * Comparator for sorting CDs by code, in ascending order.
 * @author kawam001
 *
 */
public class CDCodeComparator implements Comparator<Object> {

	public int compare(Object conceptObject1, Object conceptObject2)
    {
		CD cd1 = (CD) conceptObject1;
		CD cd2 = (CD) conceptObject2;
        int returnValue = (cd1.getCode()).compareTo(cd2.getCode());
        return returnValue;
    }	
}
