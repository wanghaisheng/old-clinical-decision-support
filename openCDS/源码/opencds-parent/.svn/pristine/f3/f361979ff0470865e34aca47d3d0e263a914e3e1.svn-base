...
{
    private static StreamUtility instance;  //singleton instance

    private StreamUtility()
    {
    }

    public static synchronized StreamUtility getInstance()
    {
        if (instance == null) instance = new StreamUtility();
        return instance;
    }
