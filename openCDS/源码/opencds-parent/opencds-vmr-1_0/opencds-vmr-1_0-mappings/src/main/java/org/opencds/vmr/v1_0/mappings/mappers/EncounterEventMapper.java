...
public class EncounterEventMapper extends EncounterBaseMapper {
	...
	public static void pullIn(
			org.opencds.vmr.v1_0.schema.EncounterEvent 		source, 
			EncounterEvent 									target, 
		...
		if ( source.getEncounterEventTime() != null ) target.setEncounterEventTime(MappingUtility.iVLTS2IVLDateInternal(source.getEncounterEventTime()));

		factLists.internalEncounterEventList.add(target);
