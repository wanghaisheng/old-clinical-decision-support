...
public class EntityRelationshipMapper {
	 ...
	 * @param factLists
	 */
	public static void pullIn(String sourceId, org.opencds.vmr.v1_0.schema.II targetId, org.opencds.vmr.v1_0.schema.CD targetRelationshipToSource, 
			org.opencds.vmr.v1_0.schema.IVLTS relationshipTimeInterval, FactLists factLists) {
		...
		target.setTargetEntityId(MappingUtility.iI2FlatId(targetId));
		...
		factLists.internalEntityRelationshipList.add(target);
		return;
	}
