...
public abstract class ClinicalStatementMapper extends Object {
	...
	public static void pullIn(
			org.opencds.vmr.v1_0.schema.ClinicalStatement	source, 
			ClinicalStatement								target, 
		...
		if (source.getTemplateId() != null) target.setTemplateId(MappingUtility.iIList2FlatIdList(source.getTemplateId()));
		target.setId( MappingUtility.iI2FlatId(source.getId()));
		if ( source.getDataSourceType() != null ) target.setDataSourceType(MappingUtility.cD2CDInternal(source.getDataSourceType()));
