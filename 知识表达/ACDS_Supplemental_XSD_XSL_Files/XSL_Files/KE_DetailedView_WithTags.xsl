...
-->
	...
	<xsl:template match="StructuredCDSKnowledge|StructuredGuideline|structuredCDSKnowledge|structuredGuideline">
		...
		<p align="center" class=".headerTitle">Developer / Knowledge Engineer with Tags Style Sheet
		</p>
		<table width="100%">
			<tr>
				<td class="divider"/>
			...
			<tr>
				<td class="heading">
					<xsl:value-of select="Metadata/identity/description"/>&#160;&#160;<u>[Metadata/identity/description]</u>
					<br/>
				</td>
			</tr>
			<tr>
			...
			<table width="100%">
				<xsl:if test="Metadata/contributor/organization/name!=''">
					<tr>
						...
						<td width="88%" class="field" valign="top"><xsl:value-of select="Metadata/contributor/organization/name" />&#160;<u>[Metadata/contributor/organization/name]</u></td>
					</tr>
				</xsl:if>
				<xsl:if test="Metadata/implementation/knowledgeType">
				<tr>
					<td width="12%" class="fieldTitle" valign="top"><b>Knowledge Type:</b></td>
					<td width="88%" class="field" valign="top"><xsl:value-of select="Metadata/implementation/knowledgeType" />&#160;<u>[Metadata/implementation/knowledgeType]</u></td>
				</tr>
				</xsl:if>
				<xsl:if test="Metadata/stateChangeEvent/eventCode">
					<tr>
						...
						<td width="88%" class="field" valign="top">
							...
							<u>[Metadata/stateChangeEvent/eventCode,&#160;Metadata/stateChangeEvent/eventDateTime</u>
						</td>
					</tr>
				</xsl:if>
			</table>
		...
		<xsl:if test="Metadata/coverage">
			<span class="fieldTitle">
				<!--Search Criteria-->
				<!--		The following search tags have been identified for this artifact:-->
				<xsl:if test="Metadata/identity/title!=''">
					<b><xsl:value-of select="Metadata/identity/title"/>&#160;&#160;<u>[Metadata/identity/title]</u></b>
				</xsl:if>
			</span>
				...
				<xsl:for-each select="Metadata/coverage">
					<tr>
						...
						<td class="field" width="89%" valign="top">
							...
							&#160;&#160;<u>[Metadata/coverage/code/@displayName  (Metadata/coverage/code/@codeSystemName:  Metadata/coverage/code/@code)]</u>
					</td>
					</tr>
				</xsl:for-each>
			</table>
			...
			<xsl:for-each select="module">
				<xsl:if test="module/Metadata/identity/title != ''">
					<table width="100%">
						...
						<tr>
							<td class="fieldTitle">
								<b><xsl:value-of select="Metadata/identity/title"/>&#160;&#160;<u>[Module/Metadata/identity/title]</u></b>
								<br/>
								<span class="headingContent">
									<xsl:value-of select="Metadata/identity/description"/>&#160;&#160;<u>[Module/Metadata/identity/description]</u>
				...
				<xsl:if test="recommendation">
					<xsl:for-each select="recommendation">
						<xsl:if test="Metadata/identity/title!=''">
							<span class="fieldTitle">
								<b><xsl:value-of select="Metadata/identity/title"/>&#160;&#160;<u>[Recommendation/Metadata/identity/title]</u></b>
							</span>
							<br/>
						</xsl:if>
						<xsl:if test="Metadata/identity/description!=''">
							<span class="field">
								<xsl:value-of select="Metadata/identity/description"/>&#160;&#160;<u>[Recommendation/Metadata/identity/description]</u>
							</span>
							<!-- new code for relatedResource -->
							<xsl:if test="Metadata/identity">
								<xsl:apply-templates select="Metadata/identity" />
	...
	<xsl:template name="relatedResource">
		<tr>
			<td width="11%" class="field" valign="top">
				<xsl:if test="type!=''"><xsl:value-of select="type" />:&#160;<br /></xsl:if><u>[relatedResource/type]</u>
			</td>
			<td width="89%" class="field" valign="top">	
				...
				<u>[Metadata/identity/relatedResource/resource/description or Metadata/identity/relatedResource/resource/title:&#160; Metadata/identity/relatedResource/type:&#160;&#160;(Metadata/identity/relatedResource/resource/location]</u>	
			</td>
		</tr>
	</xsl:template>
	...
	<xsl:template match="Advice">
		<xsl:if test="title!=''">
			<span class="fieldTitle"><b><xsl:value-of select="title" />&#160;&#160;<u>[Advice/title]</u></b></span>
	  </xsl:if>
	...
	<xsl:template match="ActionOrganizer">
		...
		<table width="100%" cellspacing="0" class="field">
	...
	<xsl:template match="EncounterRequest">
		<xsl:call-template name="createRequest">
			...
			<xsl:with-param name="path" select="'EncounterRequest/encounterProvider'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template match="KnowledgeAssetRequest">
		<xsl:call-template name="createRequest">
			...
			<xsl:with-param name="targetCode" select="target/@code" />
			<xsl:with-param name="targetCodeSystemName" select="target/@codeSystemName" />
			<xsl:with-param name="path" select="'KnowledgeAssetRequest/resource/knowledgeResourceType'" />
		</xsl:call-template>
	</xsl:template>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td class="field">
					...
					</b>&#160;&#160;<u>[MessageRequest/target/@codeSystemName]</u>
				</td>
			</tr>
			<tr>
				<td class="field">
					<xsl:value-of select="Message/freeTextMessage/@value"/>&#160;&#160;<u>[MessageRequest/Message/freeTextMessage/@value]</u>
				</td>
			</tr>
		</table>
	</xsl:template>
	...
	<xsl:template match="MessageRequestNew">
		...
		<tr>
			<td class="field" colspan="4">
				...
				&#160;&#160;<u>[MessageRequest/target/@codeSystemName]</u><br />
				<xsl:value-of select="Message/freeTextMessage/@value"/>&#160;&#160;<u>[MessageRequest/Message/freeTextMessage/@value]</u>
			</td>
		</tr>
	</xsl:template>
	...
	<xsl:template match="ProcedureRequest">
		<xsl:call-template name="createRequest">
			...
			<xsl:with-param name="targetCode" select="target/@code" />
			<xsl:with-param name="targetCodeSystemName" select="target/@codeSystemName" />
			<xsl:with-param name="path" select="'ProcedureRequest/procedureTypeCode'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template match="SubstanceAdministrationRequest">
		<xsl:call-template name="createRequest">
			...
			<xsl:with-param name="targetCode" select="target/@code" />
			<xsl:with-param name="targetCodeSystemName" select="target/@codeSystemName" />
			<xsl:with-param name="path" select="'SubstanceAdministrationRequest/codedProductName'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template match="EventRequest|eventRequest">
		<xsl:call-template name="createRequest">
			...
			<xsl:with-param name="targetCode" select="target/@code" />
			<xsl:with-param name="targetCodeSystemName" select="target/@codeSystemName" />
			<xsl:with-param name="path" select="'EventRequest/eventType'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template match="SupplyRequest">
		<xsl:call-template name="createRequest">
			...
			<xsl:with-param name="targetCode" select="target/@code" />
			<xsl:with-param name="targetCodeSystemName" select="target/@codeSystemName" />
			<xsl:with-param name="path" select="'SupplyRequest/supplyTypeCode'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:call-template name="createRequest">
			...
			<xsl:with-param name="targetCode" select="target/@code" />
			<xsl:with-param name="targetCodeSystemName" select="target/@codeSystemName" />
			<xsl:with-param name="path" select="'ClinicalStateRequest/stateCode'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template match="LogicalConditionSet">
		...
		<xsl:if test="title!=''">
			...
			</span>&#160;&#160;<u>[LogicalConditionSet/title]</u>
			<br />
		</xsl:if>
		<xsl:choose>
			<xsl:when test="$logicalConditionSetCode!='' and (ApplicableScenario)">
				<table width="100%" border="1">
					<tr>
						<td width="2%" class="field"><b><i><xsl:value-of select="$logicalConditionSetCode" /></i></b>&#160;&#160;<u>[LogicalConditionSet/operator/@code]</u></td>
	...
	<xsl:template match="LogicalConditionSingle">
		<table width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<td width="2%"></td>
				<td width="2%"></td>
				<td class="field" valign="top" width="15%"></td>
				<td class="field" valign="top" width="81%"></td>
			</tr>
			<tr>
				<td width="2%">&#160;</td>
				<td colspan="3" class="field">
					<xsl:choose>
						<xsl:when test="description!=''">
							<b><xsl:value-of select="description"/></b>&#160;&#160;<u>[LogicalConditionSingle/description]</u>
						</xsl:when>
						<xsl:when test="title!='' and ancestor::*/ancestor::*/recommendation!=''">
							<b>
								<xsl:value-of select="title"/>&#160;&#160;<u>[LogicalConditionSingle/title]</u>
							</b>
						</xsl:when>
						<xsl:otherwise>
							<b><xsl:value-of select="title"/></b>&#160;&#160;<u>[LogicalConditionSingle/title]</u>
						</xsl:otherwise>
					</xsl:choose>
				</td>
			</tr>
			<xsl:if test="expression!='' or dataMapping/expression!=''">
				<tr>
					...
					<td width="81%" valign="top" class="field" align="left">
						<xsl:if test="expression!=''"><xsl:value-of select="expression"/>&#160;&#160;<u>[LogicalConditionSingle/expression]</u></xsl:if>
						<xsl:if test="expression!='' and dataMapping/expression!=''"><br /></xsl:if>
						<xsl:if test="dataMapping/expression!=''"><xsl:value-of select="normalize-space(dataMapping/expression)"/>&#160;&#160;<u>[dataMapping/expression]</u></xsl:if>
					</td>
				</tr>
			</xsl:if>
	...
	<xsl:template match="dataMapping/Data">
		<xsl:if test="ClinicalState">
			<tr>
				<td width="2%">&#160;</td>
				<td width="2%">&#160;</td>
				<td class="field" valign="top" width="15%">Clinical State:</td>
					...
					<table cellpadding="0" cellspacing="0" border="1" width="100%" align="center">
						...
						<xsl:for-each select="ClinicalState">
							<xsl:call-template name="createTypeStatusTable">
								...
								<xsl:with-param name="pathCode" select="'ClinicalState/stateCode'" />
								<xsl:with-param name="pathStatus" select="'ClinicalState/stateStatus'" />
							</xsl:call-template>
						</xsl:for-each>
					</table>
				</td>
					...
					<table cellpadding="0" cellspacing="0" border="1" width="100%" align="center">
						...
						<xsl:for-each select="gender">
							<xsl:call-template name="createTypeStatusTable">
								...
								<xsl:with-param name="pathCode" select="'gender'" />
								<xsl:with-param name="pathStatus" select="''" />
							</xsl:call-template>
						</xsl:for-each>
					</table>
				</td>
		...
		<xsl:if test="LaboratoryResult">
			<tr>
				...
				<td class="field" valign="top" width="81%">
					<table cellpadding="0" cellspacing="0" border="1" width="100%" align="center">
						<xsl:call-template name="createColumnsForLabs" />
						<xsl:for-each select="LaboratoryResult">
						<tr>
								<td class="field" valign="top">
									<xsl:value-of select="resultType/@displayName"/>&#160;&#160;(<xsl:value-of select="resultType/@codeSystemName"/>:&#160;&#160;
									<xsl:value-of select="resultType/@code"/>)
									<u>[@displayName  (@codeSystemName: @code)]</u>
								</td>
								<td class="field" valign="top">
					...
					<table cellpadding="0" cellspacing="0" border="1" width="100%" align="center">
						...
						<xsl:for-each select="Procedure">
							<xsl:call-template name="createTypeStatusTable">
								...
								<xsl:with-param name="pathCode" select="'Procedure/procedureType'" />
								<xsl:with-param name="pathStatus" select="'Procedure/procedureStatus'" />
							</xsl:call-template>
						</xsl:for-each>
					</table>
				</td>
					...
					<table cellpadding="0" cellspacing="0" border="1" width="100%" align="center">
						...
						<xsl:for-each select="VitalSign">
							<xsl:call-template name="createTypeStatusTable">
								...
								<xsl:with-param name="pathCode" select="'VitalSign/vsType'" />
								<xsl:with-param name="pathStatus" select="'VitalSign/vsStatus'" />
							</xsl:call-template>
						</xsl:for-each>
					</table>
				</td>
	...
	<xsl:template match="Definition">
		<table width="100%" cellpadding="2" cellspacing="2" cols="2">
			...
			<xsl:for-each select="definition">
				<tr>
					<td class="field" valign="top">
						<xsl:value-of select="code/@displayName"/>&#160;&#160;<u>[Definition/code/@displayName]</u>
					</td>
					<td class="field">
						<xsl:value-of select="code/@code"/>&#160;(<xsl:value-of select="code/@codeSystemName"/>:&#160;<xsl:value-of select="code/@codeSystemVersion"/>)
						&#160;&#160;<u>[Definition/definition/code/@code] (Definition/definition/code/@codeSystemName: Definition/definition/code/@codeSystemVersion)</u>
					</td>
				</tr>
			</xsl:for-each>
		</table>
		...
		<span class="field" title="{$hoverText}">
			...
			<xsl:choose>
				<xsl:when test="$textAlternative!=''">
					<xsl:value-of select="$textAlternative"/>&#160;
					<xsl:if test="$hoverText!=''">-&#160;<xsl:value-of select="$hoverText" />&#160;</xsl:if>
					&#160;&#160;<u>[textAlternative] - <xsl:value-of select="$path" />/@displayName]</u>
				</xsl:when>
				<xsl:when test="$title!=''" >
					<xsl:value-of select="$title"/>&#160;
					<xsl:if test="$hoverText!=''">-&#160;<xsl:value-of select="$hoverText" />&#160;</xsl:if>
					&#160;&#160;<u>[title] - <xsl:value-of select="$path" />/@displayName]</u>
				</xsl:when>
				<xsl:otherwise><xsl:value-of select="$hoverText"/>&#160;&#160;<u>[<xsl:value-of select="$path" />/@displayName]</u></xsl:otherwise>
			</xsl:choose>
			&#160;
			(<xsl:value-of select="$hoverCodeSystemName"/>:&#160;&#160;<xsl:value-of select="$hoverCode"/>)&#160;
			<xsl:if test="$targetDisplayName!=''">
				<br />&#160;&#160;&#160;&#160;&#160;&#160;&#160;<i><b>Target:</b></i>&#160;<xsl:value-of select="$targetDisplayName" />&#160;(<xsl:value-of select="$targetCodeSystemName" />:&#160;&#160;<xsl:value-of select="$targetCode" />)
				<u>[target/@displayName (target/@codeSystemName: target@code)]</u>
			</xsl:if>
			<xsl:if test="$location!=''">
				<!--<br />&#160;&#160;&#160;&#160;&#160;-->
				&#160;&#160;<span class="fieldLink">
					<a target='_blank'><xsl:attribute name="href"><xsl:value-of select="$location" /></xsl:attribute><xsl:value-of select="$location" /></a>
				</span>
				&#160;&#160;<u>[<xsl:value-of select="$path" />/location]</u>
			</xsl:if>
			...
			&#160;<u>[(<xsl:value-of select="$path" />/@codeSystemName: <xsl:value-of select="$path" />/@code)]</u>
		</span>
	</xsl:template>
	...
	<xsl:template name="createColumnsForMeds">
		<tr>
			...
			<td width="50%" class="fieldHeader" align="center">Status for the Medication</td>
			<!--<td width="20%" class="fieldHeader" align="center">Order Date/Time</td>
			<td width="20%" class="fieldHeader" align="center">Interval</td>-->
		</tr>
	</xsl:template>
	...
	<xsl:template name="createTypeStatusTable">
		...
		<xsl:param name="pathCode" />
		<xsl:param name="pathStatus" />
		<tr>
			<td class="field" valign="top">
				<xsl:value-of select="$displayNameType"/>&#160;&#160;(<xsl:value-of select="$codeSystemNameType"/>:&#160;&#160;<xsl:value-of select="$codeType"/>)
				&#160;&#160;<u>[<xsl:value-of select="$pathCode" />/@displayName (<xsl:value-of select="$pathCode" />/@codeSystemName: <xsl:value-of select="$pathCode" />/@code)]</u>
			</td>
			<td class="field" valign="top">
				<xsl:if test="$codeSystemNameStatus!=''">
					<xsl:value-of select="$displayNameStatus"/>&#160;&#160;(<xsl:value-of select="$codeSystemNameStatus"/>:&#160;&#160;<xsl:value-of select="$codeStatus"/>)
				</xsl:if>&#160;
				&#160;&#160;<u>[<xsl:value-of select="$pathStatus" />/@displayName (<xsl:value-of select="$pathStatus" />/@codeSystemName: <xsl:value-of select="$pathStatus" />/@code)]</u>
			</td>
		</tr>
  </xsl:template>
